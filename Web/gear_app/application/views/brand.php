  ...
  <div class="content-wrapper">
    ...
    <div class="nav-tabs-custom">
			<ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Brand Master</a></li>
          ...
          <div class="row form-horizontal">
			  ...
			  <div class="col-md-6">
				  <div class="form-group">
						<label for="" class="col-sm-2 control-label">Brand ID:</label>
						<div class="col-sm-10">
          ...
          <!-- /.row -->
            ...
            <div class="box-body">
             ...
             <table id="example1" class="table table-bordered table-hover table-striped">
               <thead>
                <tr>
                  <th style="text-align:center;width:105px;">Brand Id</th>
                  <th style="text-align:center;width:145px">Brand Name</th>
				  <th style="text-align:center;width:105px;">Brand Description</th>
				  <th align="center" style="width: 61.3px;">Action</th>
                </tr>
                </thead>
                ...
                <tr>
                  ...
                  <td>ABCDE</td>
				  <td>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla vel dapibus elit, a aliquet massa.</td>
                  <td><a href=#><i class="fa fa-fw fa-edit" style="font-size:23px;padding-right:10px"></i></a></td>
                </tr>
