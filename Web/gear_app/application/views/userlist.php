  ...
  <div class="content-wrapper">
    ...
    <div class="nav-tabs-custom">
			<ul class="nav nav-tabs">
              <li class="active"id="editlist" ><a href="#activity" data-toggle="tab">User Management</a></li>		
			...
			<div class="button-section" id="buttonsection">
				<button class="btn btn-success btn-sm" id="add" onclick="addbutton('<?php echo $baseurl;?>');"></i>Add</button>
        	...
        	<div class="table-responsive">
             ...
             <table id="userdetails" class="table table-bordered table-hover table-striped userdetails">
                ...
                <tbody style="text-align:center;">
				 ...
				 $groupid=$row->FK_UserGroupId;
				 $ol_group=$row->Groupname;
				 //$branid=$row->FK_AssignedBrandID;
				 //$ol_brandname=$row->CategoryName; 
				 $branname=$row->AssignedBrands;
                 $title=$row->Title;
                 $status=$row->IsActive;
				 $emailid=$row->EmailID;
				 $imeino=$row->IMEI_No;
                ...
                ?>
				 ...
				 <tr>
				  ...
				  <td><a href=#><i class="fa fa-fw fa-eye" style="font-size:23px;padding-right:10px" onclick="edituserbutton('<?php echo $baseurl;?>','<?php echo $ol_ID;?>','<?php echo $ol_userID;?>','<?php echo $ol_name;?>','<?php echo $locationid;?>','<?php echo $status;?>','<?php echo $groupid;?>','<?php echo $title;?>','<?php echo $emailid;?>','<?php echo $imeino;?>','<?php echo $companyid;?>','<?php echo $validfrom;?>','<?php echo $validto;?>');"></i></a></td>
                </tr>				
              <?php
					 }
			  ?>
        ...
        <!-- /.col -->
			  ...
			  <div class="tab-pane" id="edittimeline">
             <div class="box box-info">
				...
				<form method="post" action="<?php echo $baseurl;?>/addUserItems">
				<div class="row form-horizontal">
				<div class="box-body">
				    <div class="col-sm-12">					
						...
						<input type="hidden" name="id" id="id">
						  <label  class="col-sm-5 control-label">User ID:</label>
							...
							<input class="form-control input-sm"  type="textbox" name="userid" id="userid" >
						  </div>
						</div>
						<div class="form-group  col-sm-4">
						  <label  class="col-sm-5 control-label"> Name:</label>
						  <div class="col-sm-7">
							<input class="form-control input-sm"  type="textbox" name="name" id="name">
						  </div>
						</div>	
						<div class="form-group  col-sm-4">
						  <label  class="col-sm-5 control-label"> Title:</label>
						  <div class="col-sm-7">
							<input class="form-control input-sm"  type="textbox" name="title" id="title" >
						  </div>
						</div>						
					</div>
					...
					<div class="form-group col-sm-4">
						  <label  class="col-sm-5 control-label">EmailID :</label>
							<div class="col-sm-7">
							<input class="form-control input-sm"  type="textbox" name="emailid"  id="emailid">
						   </div>
						</div>
						<div class="form-group col-sm-4">
						  <label  class="col-sm-5 control-label">IMEI_No:</label>
							<div class="col-sm-7">
							<input class="form-control input-sm"  type="textbox" name="IMEI_No" id="IMEI_No" >
						  </div>
						</div>
						<div class="form-group col-sm-4">
					...
					<div class="col-sm-12" style="margin-bottom:9px;" id="pwddiv">
							<div class="form-group col-sm-4">
						  <label  class="col-sm-5 control-label"> Password :</label>
							<div class="col-sm-7">
							<input class="form-control input-sm"  type="textbox" name="password" id="password" >
						   </div>
						</div>
					...
					<div class="col-sm-12" style="margin-bottom:9px;">						
						<div class="form-group col-sm-4">					
						<label  class="col-sm-5 control-label">User Group:</label>
							<div class="col-sm-7">
					...
					<div class="col-sm-12" style="margin-bottom:9px;" >	
							...
							<div class="form-group col-sm-4" id="validfrmdiv">
								<label for="" class="col-sm-5 control-label"> Valid From:</label>
								<div class="col-sm-7">
						  ...
						  <!-- /.form-group -->
							  ...
							  <div class="form-group col-sm-4" id="validtodiv">
									<label for="" class="col-sm-5 control-label"> Valid To:</label>
									<div class="col-sm-7">						 
							...
							<div class="col-sm-7">							
							<select name="branditem[]" id="branditem" multiple>								
							</select>
						   </div>
						</div>
						  <!-- /.form-group -->
					...
					<div  class="text-center">
						...
						<button class="btn btn-danger" type="button" onclick="returnuserbutton();">Cancel</button>
						<button class="btn btn-warning" type="button" onclick="returnuserbutton();">Return</button>
						</div>
					</div>
				</div>
				</form>
