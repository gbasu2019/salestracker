...
?>
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
			  ...
			  <p>Monthly : <?php echo $monthlyordercount;?></p>
              <p>Today's : <?php echo $todayordercount;?></p>
			  <p>Approved : <?php echo $approvedordercount;?></p>
			  <p>Pending : <?php echo $pendingordercount;?></p>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <p>Monthly : <?php echo $monthlygrncount;?></p>
			  <p>Today's : <?php echo $todaygrncount;?></p>
              <p>Approved : <?php echo $approvedgrncount;?></p>
              <p>Pending : <?php echo $pendinggrncount;?></p>
              <p><strong>GRN Viewer</strong></p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <p>Monthly : Rs.<?php echo $monthlycollection;?>/-</p>
              <p>Monthly Cash Collection: Rs.<?php echo $cashcollectioncount;?>/-</p>
			  <p>Monthly Bank Collection: Rs.<?php echo $bankcollectioncount;?>/-</p>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <p>Monthly : <?php echo $monthlyvisitcount;?></p>
			  <p>Today's : <?php echo $todayvisitcount;?></p>
              <p>Approved : <?php echo $approvedvisitcount;?></p>
              <p>Pending : <?php echo $pendingvisitcount;?></p>
  ...
  <!-- Control Sidebar -->
  <aside id="abcd" class="control-sidebar control-sidebar-dark">
    <!-- Create the tabs -->
