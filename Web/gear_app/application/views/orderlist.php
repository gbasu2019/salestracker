  ...
  <div class="content-wrapper">
    ...
    <div class="nav-tabs-custom">
			<ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Order Management</a></li>
			  <li id="listTimeline" class="disabled"><a href="#timeline" id="timelinetab">View/Edit Order</a></li>
            </ul>
        ...
        <div class="col-xs-12">
          <div class="box box-info">
			...
			<form id="orderlistform" name="orderlistform" method="post" action="<?php echo $baseurl;?>/getOrderListItems">
        ...
        ?>
		  ...
		  <div class="col-md-4">
				  <div class="form-group">
						<label for="" class="col-sm-5 control-label">Order Number:</label>
						<div class="col-sm-7">
						   <input type="text" class="form-control" id="orderno" name="orderno" value="<?php echo $orderno;?>">
						</div>
				 </div>
              <!-- /.form-group -->
			</div>
			  ...
			  <div class="form-group">
						...
						<div class="col-sm-7">
						    <select class="form-control" id="orderstatus" name="orderstatus">
							  <option <?php if($orderstatus==0)echo " selected ";else echo "";?> value="" >Select</option>
							  <?php
                  foreach ($status_table->result() as $row)
                     {

                 if($row->PK_StatusID==$orderstatus){
			...
			<div class="form-group">
						<div class="col-sm-10 filter">
							...
							<a href="<?php echo $baseurl;?>/getOrderListItems">
          ...
          <!-- /.row -->
            ...
            <div class="box-body">
             ...
             <table id="example" class="table table-bordered table-hover table-striped display example"  style="width:100%">
                <thead>
					<tr>
					  <th style="text-align:center;width:145px;">Order Date</th>
					  <th style="text-align:center;width:145px">Order Number</th>
					  <th style="text-align:center;width:105px;">Sales Person</th>
					  <th style="text-align:center;width:145px">Customer Name</th>
					  <th style="text-align:center;width:145px">Company Name</th>
                ...
                <tbody style="text-align:center;">
				 ...
				 <?php
                  foreach ($orderlist_table->result() as $row)
                     {
              
						 $ol_orderno=$row->OrderNo;
						 $ol_username=$row->UserName;
						 $ol_dealername=$row->DealerName;
						 $ol_orderstatus= $row->OrderStatus;
						 $time = strtotime($row->OrderDate); 
						 $ol_orderdate = date('d-m-Y',$time); 
						 $ol_orderid =$row->OrderID;
						 $companyname =$row->Companyname;
                 
                ?>

                <tr>
                  <td style="text-align:center;"><?php echo  $ol_orderdate;?></td>
                  <td><?php echo $ol_orderno;?></td>
				  <td><?php echo $ol_username;?></td>
                  <td><?php echo $ol_dealername;?></td>
				  <td><?php echo $companyname;?></td>
				  <td <?php if($ol_orderstatus=='Open') {?> style="color:blue;font-weight:bold;" <?php }?>
				  <?php if($ol_orderstatus=='Approved') {?> style="color:green;font-weight:bold;" <?php }?>
				  <?php if($ol_orderstatus=='Cancelled'){?> style="color:red;font-weight:bold;" <?php }?>><?php echo $ol_orderstatus;?></td>
				  <td><a href=#><i class="fa fa-fw fa-eye" style="font-size:23px;padding-right:10px" onclick="editbutton('<?php echo $baseurl;?>','<?php echo $ol_orderid;?>','<?php echo $ol_orderno;?>','<?php echo $ol_username;?>','<?php echo $ol_dealername;?>','<?php echo $ol_orderstatus;?>','<?php echo $ol_orderdate;?>');"></i></a></td>
                </tr>				
              <?php
					 }
			  ?>
        ...
        <!-- /.col -->
				...
				<div class="box-body">
					...
					<div class="form-group  col-sm-4">
					  ...
					  <div class="col-sm-7">
						<div class='input-group date' id='datepicker2'>
							<input type='text' class="form-control" id="selectedOrderDate" name="selectedOrderDate" />
							<span class="input-group-addon">
							<span class="glyphicon glyphicon-calendar"></span>
							</span>
						</div>
					...
					<div class="form-group col-sm-4">
					  <label  class="col-sm-5 control-label">Order Number:</label>
						<div class="col-sm-7">
						<input class="form-control input-sm"  type="textbox" id="selectedOrderNumber" name="selectedOrderNumber" readonly>
					  </div>
					</div>
					<div class="form-group col-sm-4">
			...
			<div class="tab-pane" id="timeline">
			 ...
			 <!--
				...
				<div class="box-body" >
						<div class="table-responsive"> 
						<table id="details" name="example1" class="table table-bordered table-hover table-striped display details">
						<thead>
							<tr>
							<!--
							  ...
							  <th style="text-align:center;width:145px">Approved Qty.</th>
							</tr>
						</thead>
					...
					<button class="btn btn-primary" type="Submit" onclick="savedata('<?php echo $baseurl;?>')" data-toggle="modal" data-target="#modal-default-Submit">Save</button>
