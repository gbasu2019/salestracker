  ...
  <div class="content-wrapper">
    ...
    <section class="content-header" style="padding-top:15px;">
      ...
      <ol class="breadcrumb" style="padding-top:18px;">
        ...
        <li class="active">Collection Management</li>
      </ol>
    </section>
    ...
    <div class="nav-tabs-custom">
			<ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Collection Management</a></li>
        ...
        <div class="col-xs-12">
          <div class="box box-info">
            <div class="box-header" style="background-color: #337ab7; color: #fff">
              <h3 class="box-title">Collection Management</h3>
			...
			<form method="post" action="<?php echo $baseurl;?>/getCollectionItems">
          <div class="row form-horizontal">
		  
		  <div class="col-sm-12">
		  <div class="col-md-4">
				  <div class="form-group">
						<label for="" class="col-sm-5 control-label">Collection No.:</label>
						<div class="col-sm-7">
						   <input type="text" class="form-control" name="collectionid" <?php if(!empty($collectionid)){ ?> value="<?php echo $collectionid;?>"<?php }?> >
						</div>
				 </div>
              <!-- /.form-group -->
			</div>
			<div class="col-md-4">
			  <div class="form-group">
						<label for="" class="col-sm-5 control-label">Collection Type:</label>
						<div class="col-sm-7">
						    <select class="form-control" id="collectiontype" name="collectiontype">
							  <option <?php if($collectiontype==0)echo " selected ";else echo "";?> value="" >Select</option>
							  <option value="Bank" <?php if($collectiontype=='Bank'){ echo 'selected';} ?>>Bank</option>
							  <option value="Cash" <?php if($collectiontype=='Cash'){ echo 'selected';} ?>>Cash</option>
			...
			<div class="form-group">
						<div class="col-sm-10 filter">
						  <!--  <button type="button" class="btn btn-google btn-inner" id="closebtn"><i class="fa fa-close"style="margin-right: 4px;"></i>Close</button> -->
							<a href="<?php echo $baseurl;?>/getCollectionItems">
          ...
          <!-- /.row -->
            ...
            <div class="box-body">
             ...
             <table id="example" class="table table-bordered table-hover table-striped display example" >
                <thead>
                ...
                <tbody style="text-align:center;">
					 <?php
                  foreach ($collectionlist_table->result() as $row)
                     {
              
                 $ol_collectionid=$row->CollectionID;
				 $ol_username=$row->UserName;
				 $ol_dealername=$row->DealerName;	
				 $ol_collectiontype=$row->Type;	
                 $ol_bank=$row->Type;						 
				 $timestamp = strtotime($row->CreatedDate); 
				 $ol_amount=$row->amount;	
				 $Collectionimage=$row->ReferralImage;
				 $address=$row->Location;
				 $ol_Collectiondate = date('d-m-Y',$timestamp);    
				 $ol_Bankname=$row->Bankname;	
				 $ol_transactionID=$row->transactionID;	
                 $ol_ChequeNo=$row->ChequeNo;			 
                ?>
				
				 <tr>
                  <td style="text-align:center;"><?php echo  $ol_Collectiondate;?></td>
				  <td><?php echo $address;?></td>
				  <td><?php echo $ol_username;?></td>
				  <td><?php echo $ol_collectiontype;?></td>
                  <td><?php echo $ol_Bankname;?></td>    
				  <td><?php echo $ol_transactionID;?></td>  				  
				  <td><?php echo $ol_ChequeNo;?></td>  	
				  <td><?php echo  number_format((float)$ol_amount, 2, '.', '');?></td>			  
				  <td>				   
				   <?php if(!empty($Collectionimage)) {?>
				   <img src="<?php echo $Collectionimage;?>" width="50" height="50" id="myImg<?php echo $ol_collectionid;?>" class="myImg" >
 <?php 
				 }?>				   
				   </td>				  
				 
				<div id="myModal<?php echo $ol_collectionid;?>" class="modal">
  <span class="closemodal" id="closemodal<?php echo $ol_collectionid;?>" style="color:white;">&times;</span>
  <img class="modal-content" id="img<?php echo $ol_collectionid;?>">
  
</div>
 <?php if(!empty($Collectionimage)) {?>
<script>

	document.getElementById('myImg<?php echo $ol_collectionid;?>').onclick = function(){
    document.getElementById('myModal<?php echo $ol_collectionid;?>').style.display = "block";	
    document.getElementById('img<?php echo $ol_collectionid;?>').src = this.src;	
    
};

  document.getElementById('closemodal<?php echo $ol_collectionid;?>').onclick = function() {
  document.getElementById('myModal<?php echo $ol_collectionid;?>').style.display = "none";
}
</script>
<?php 
				 }?>
        ...
        <!-- /.col -->
             ...
             <div class="box box-info">
				...
				<div class="box-body">
					...
					<div class="form-group  col-sm-4">
					  ...
					  <div class="col-sm-7">
						<div class='input-group date' id='datepicker2'>
							<input type="text" class="form-control" id="selectedCollectionDate" name="selectedCollectionDate"/>
							<span class="input-group-addon">
							<span class="glyphicon glyphicon-calendar"></span>
							</span>
						</div>
					...
					<div class="form-group col-sm-4">
					  <label  class="col-sm-5 control-label">Collection Number:</label>
						<div class="col-sm-7">
						<input class="form-control input-sm"  type="textbox" name="collectionid" >
					  </div>
					</div>
					<div class="form-group col-sm-4">
					...
					<div class="table-responsive"> 
						...
						<thead>
							<tr>
							  <th style="text-align:center;width:145px;">Collection ID</th>
							  <th style="text-align:center;width:145px;">Bank Name</th>
							  <th style="text-align:center;width:145px">Transaction ID</th>
							  <th style="text-align:center;width:105px;">Cheque</th>
							  <th style="text-align:center;width:145px">Cheque No</th>
...
<script>
    ...
    $(function () {
	  ...
	  $(function () {
	   var exportTitle = "Collection Report";
	   $('.example').DataTable({
        dom: 'Bfrtip',
			"columnDefs": [    
	{ "width": "10%", "targets": 0 },
