...
?>
  <div class="content-wrapper">
   <!-- Content Header (Page header) -->
	...
	<section class="content" style="overflow-x:auto; max-height:750px;">
		<div class="nav-tabs-custom">
			<ul class="nav nav-tabs">
              <li class="active"id="editlist" ><a href="#activity" data-toggle="tab">Manage Dealers</a></li>		
		...
		<!-- <a class="btn btn-success btn-sm" href="<?php echo $baseurl;?>/sales_manager_add">Add</a> -->
           ...
           <div class="box-body">
        	<div class="table-responsive">
             ...
             <table id="dealerdetails" class="table table-bordered table-hover table-striped dealerdetails">
	...
	<?php foreach($tbl_master_dealerinformation as $t){ ?>
    <tr>
		
		<td><?php echo $t['FK_CompanyID']; ?></td>
		<td><?php echo $t['DealerName']; ?></td>
		<td><?php echo $t['cwCategory']; ?></td>
		<td><?php echo $t['cwExecutiveName']; ?></td>
		<td><?php echo $t['cwProductName']; ?></td>
		<td><?php echo $t['FK_CategoryID']; ?></td>
		<td><?php echo $t['OpeningBalance']; ?></td>
		<td><?php echo $t['ClosingBalance']; ?></td>
		<td>
            <a href="<?php echo site_url('tbl_master_dealerinformation/edit/'.$t['PK_DealerID']); ?>">Edit</a> 
